...
\includegraphics[scale=1.7]{images/led_driver_rev1.eps}
\label{driver_rev1}
}
\subfigure[Ein Entwurf von Revision 3 des LED-Treibers einer LED]{
\includegraphics[scale=2.2]{images/led_driver_rev3.eps}
\label{driver_rev3}
}
\label{driver_revs}
...
\begin{figure}
\centering
\includegraphics[width=12cm]{images/chips_smaller.eps}
\label{ics_used}
